...
class PreguntaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create preguntum" do
    assert_difference('Preguntum.count') do
      post pregunta_url, params: { preguntum: { cuerpo: @preguntum.cuerpo, titulo: @preguntum.titulo, votos: @preguntum.votos } }
    end
  ...
  test "should update preguntum" do
    patch preguntum_url(@preguntum), params: { preguntum: { cuerpo: @preguntum.cuerpo, titulo: @preguntum.titulo, votos: @preguntum.votos } }
